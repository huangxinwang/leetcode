...
//////////////////////////////////////////////////////////////
// 2015/11/07
// Highlight: start at each position, and use dfs to see if any match exist
public class Solution {
    public boolean exist(char[][] board, String word) {
        int m = board.length;
    ...
    //dfs to find next char in target string
    public boolean dfs(char[][] board, String word, int i, int j, int k){
        ...
        if(word.charAt(k)==board[i][j]){
            ...
            //use a char to indicate this box has been usd
            board[i][j] = '#';
